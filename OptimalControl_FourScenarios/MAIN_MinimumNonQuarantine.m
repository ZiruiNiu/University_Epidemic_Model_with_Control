...
% non-quarantine intervention scenario based on the designed University 
...
% With feasible initial guesses, we can try to minimize norm of the three
% non-qurarntine control variables while guaranteeing the 95% infection-free
% requirement.
...
% Minimize norm of the three non-qurarntine control variables. The division
% is used to normalize the input varialbes
R_2 = diag([100; 100; 100; 1e-2; 1e-2]) ./ ([0.7; 0.7; 0.7; 0.5/param.eta_y; 0.5/param.eta_s].^2);
