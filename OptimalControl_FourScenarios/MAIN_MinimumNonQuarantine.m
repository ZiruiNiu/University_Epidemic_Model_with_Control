...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
param.beta_yy = 0.0910;
param.beta_ss = 0.1098;
param.p = 1.2072;
param.k = 1.5;
param.beta_cy = 0.0954;
param.beta_cs = 0.1152;
param.epsilon_y = 0.2;
param.epsilon_s = 0.1;
param.xi_y = 0.0857;
param.xi_s = 0.0429;
...
% For faster running, just set zeros
R_1 = diag([0; 0; 0; 0; 0]);
...
R_2 = diag([100; 100; 100; 1e-2; 1e-2]);
...
problem2.bounds.finalState.low = [0.94*param.Pop_y/param.Pop; 0.94*param.Pop_s/param.Pop; zeros(9,1)];
